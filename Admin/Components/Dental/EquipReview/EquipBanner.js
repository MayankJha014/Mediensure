"use client";
import { uploadDentalBanner, uploadDentalEquipmentBanner } from '@/store/Action/Authentication';
import { Button } from '@mui/material';
import React from 'react'
import { useState } from 'react';
import { useDispatch, useSelector } from 'react-redux';

const EquipBanner = ({setbanner}) => {
  ...
  const handleSubmit = (e)=>{
      ...
      dispatch(uploadDentalEquipmentBanner(formData));
      setImg("");
      setbanner(false);
  }
  return (
