...
import { getDental } from "@/store/Action/others";
    ...
    <Nav/>
      ...
      >
        ...
        {banner ? (
          ...
          <Plan setopen={setplan} />
        ) : inclusion ? (
          <Inclusion setopen={setinclusion} />
        ) : loading ? (
          ...
          <div className="w-full relative overflow-x-hidden overflow-y-auto p-10 ">
            <div className="w-full flex flex-col gap-3 items-start justify-center">
              ...
              {dental?.banner?.filename ? (
                <img
                  src={`${imgLink}/${dental?.banner?.filename}/${dental?.banner?.mimetype}`}
            ...
            <div className=" w-full  flex flex-col px-20 py-12">
              ...
              {dental?.inclusion?.map((dets, index) => (
                <div
