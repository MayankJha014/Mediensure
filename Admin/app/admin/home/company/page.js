...
const page = () => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(uploadImageComnpany(formData));
    setImg("");
  };
  useEffect(() => {
  ...
  const handelCompanyDelete = (id, imageId) => {
    ...
    dispatch(deleteHomePage(id, imageId));
  };
  console.log(loading);
  return (
    <>
        ...
        <div className="w-full flex" style={{ height: "calc(100vh - 10vh)" }}>
          ...
          {loading || load ? (
            ...
            <div className="w-full flex flex-col p-10">
              <h1 className="text-3xl font-bold">Company Image</h1>
              <div className="w-full relative p-10 flex flex-col items-start justify-center ">
                ...
                <div className="flex gap-2 flex-wrap">
                  {homepage?.company &&
                    homepage?.company?.map((dets, index) => (
                      <div
                      ...
                      >
                        ...
                        ></i>
                        <img
                          className="h-[5vh] shrink-0  object-contain w-fit  "
