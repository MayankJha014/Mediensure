...
import { getLeads, getLeadsOperator } from "@/store/Action/Authentication";
...
const page = () => {
  const {providerLeads,loading,message} = useSelector((state)=>state.adminReducer)
  const dispatch = useDispatch()
  useEffect(() => {
    dispatch(getLeadsOperator())
  }, [])
  return (
    <>
      <NavOperation />
